...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._ddAnno = ft.Dropdown(label="Anno",
                                   ...
                                   options=self._controller.read_DD(),
        ...
        self.cont = ft.Container(self._txtOutSquadre, width=300, height= 200, alignment=ft.alignment.top_left, bgcolor="#deeded")

        self._btnCreaGrafo = ft.ElevatedButton(text="Crea Grafo", on_click=self._controller.handleCreaGrafo)

        row2 = ft.Row([self.cont, self._btnCreaGrafo], alignment=ft.MainAxisAlignment.CENTER, vertical_alignment=ft.CrossAxisAlignment.END)

        self._ddSquadra = ft.Dropdown(label="Squadra", options=[])  # HO LA FUNZIONE DEL CONTROLLER CHE LA RIEMPIE
    ...
    def update_page(self):
        self._txtOutSquadre.update()
        self._txt_result.update()
        self._page.update()